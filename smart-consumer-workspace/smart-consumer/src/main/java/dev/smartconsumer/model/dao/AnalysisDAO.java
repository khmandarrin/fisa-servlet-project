...
/**
 * 소비 분석 데이터 접근 객체.
 * Spring 빈으로 등록되며, 생성자 주입을 통해 Replica DataSource를 전달받음.
 */
@Slf4j
@Repository
public class AnalysisDAO {
    ...
    // 생성자 주입: AnalysisDAO는 읽기 전용이므로 Replica만 필요
    public AnalysisDAO(@Qualifier("replicaDataSource") DataSource replicaDs) {
        this.replicaDs = replicaDs;
        log.info(">>> AnalysisDAO initialized with Replica DataSource");
    }
