...
4. `sample-project`가 Eclipse에 Dynamic Web Project로 import 되어 있어야 합니다
...
2. Tomcat 콘솔에서 아래 메시지 확인:
   ```
   INFO: Manager [/sample-project] expiring sessions upon shutdown
   ```
